            ...
            return(
              <div key={recipe.id} className='grid grid-cols-7 overflow-hidden py-5 mobhid'>
                ...
                <div className="col-span-3 items-center ml-10 text-center">
                  ...
                  <div className="bll">
                    <mark className='tit px-3 text-center bg-clip-text text-transparent font-bold text-4xl mb-8 stylerq bg-gradient-to-r from-teal-500 via-purple-500 rounded-sm'>" {(recipe.title).toUpperCase()} "</mark>
                  </div>
