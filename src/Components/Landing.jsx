              ...
              <div key={recipe.id} className='grid grid-cols-7 overflow-hidden py-5 mobhid'>
                ...
                <div className="col-span-3 items-center ml-10 text-center">
                  ...
                  <div className="bll m-auto items-center justify-center text-center">
                    <mark className='tit text-center font-semibold px-3 mb-4'>" {("kljsgkj ljgdjfg jfgilfjg jgkjfdlgj lkjfdgkj").toUpperCase()} "</mark>
                    {/* <mark className='tit px-3 text-center bg-clip-text text-transparent font-bold text-4xl mb-8 stylerq bg-gradient-to-r from-teal-500 via-purple-500 rounded-sm items-center'>" {(recipe.title).toUpperCase()} "</mark> */}
                  </div>
                  ...
                  <button className='tr focus:outline-none bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900 text-center font-semibold text-sky-200 font-mono relative'>Get Recipe</button>
                </div>
