    ...
    <>
      <div className='w-100 h-62 m-auto hero mt-5'>
        ...
        <div className="mt-7 grid grid-cols-5 md:grid-cols-3 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            <NavLink to='/cuisine/Indian' className="item p-3 m-auto" >
              <div className="cir">
            ...
            <NavLink to='/cuisine/Italian' className="item p-3 m-auto">
              <div className="cir">
            ...
            <NavLink to='/cuisine/Chinese' className="item p-3 m-auto">
              <div className="cir">
            ...
            <NavLink to='/cuisine/Mexican' className="item p-3 m-auto">
              <div className="cir">
            ...
            <NavLink to='/cuisine/Japaneese' className="item p-3 m-auto">
              <div className="cir">
        ...
        <div className="catitem mt-7 grid grid-cols-5">
            <NavLink to='/type/salad' className="item p-3 m-auto">
              <div className="cir1">
              ...
              <p className='text-white text-center mt-5 bg-opacity-20 bg-amber-300 bg-blur-lg p-1 rounded-md shadow-md'>Salad</p>
            </NavLink>
            <NavLink to='/type/marinade' className="item p-3 m-auto">
              <div className="cir1">
                <img src="https://t4.ftcdn.net/jpg/01/87/57/33/360_F_187573358_rIkruVJ7wUCA8FYxonKMkLOK0WaE9bQq.jpg" alt="Non veg"/>  
              </div>
              <p className='text-white text-center mt-5 bg-opacity-20 bg-amber-300 bg-blur-lg p-1 rounded-md shadow-md'>Marinade</p>
            </NavLink>
            <NavLink to='/type/beverage' className="item p-3 m-auto">
              <div className="cir1">
            ...
            <NavLink to='/type/snack' className="item p-3 m-auto">
              <div className="cir1">
            ...
            <NavLink to='/type/dessert' className="item p-3 m-auto">
              <div className="cir1">
